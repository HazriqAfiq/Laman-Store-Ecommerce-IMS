...
<?php $component->withAttributes(['title' => 'My Sales']); ?>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-4 mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <form method="GET" action="<?php echo e(route('reseller.sales.index')); ?>" id="filter-form" class="flex flex-col sm:flex-row sm:items-center gap-3 w-full">
                ...
                <select id="month" name="month" onchange="document.getElementById('filter-form').submit()"
                    ...
                    <?php $__currentLoopData = $availableMonths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($m); ?>" <?php echo e($selectedMonth == $m ? 'selected' : ''); ?>>
                            <?php echo e(strtoupper(\Carbon\Carbon::create()->month($m)->format('F'))); ?>
        ...
        <div class="col-span-1 lg:col-span-3 bg-white rounded-2xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-7 relative">
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-[12px] font-medium text-gray-500 mt-1">Your revenue & volume for <?php echo e($periodLabel); ?></p>
                </div>
        ...
        <div class="px-7 py-6 border-b border-gray-50/80 flex items-center justify-between bg-gray-50/20">
            <div>
                ...
                <p class="text-[11px] font-medium text-gray-500 mt-1 uppercase tracking-widest">
                    <?php echo e($monthTransactions); ?> processing <?php echo e(Str::plural('record', $monthTransactions)); ?> for <?php echo e($periodLabel); ?>
                ...
                options: {
                    ...
                    scales: {
                        ...
                        yUnits: { 
                            ...
                            ticks: { stepSize: Math.max(1, Math.ceil(Math.max(...<?php echo json_encode($trendUnits, 15, 512) ?>)/5)), padding: 10 } 
                        },
                        x: { 
                            grid: { display: false }, border: { display: false }, 
