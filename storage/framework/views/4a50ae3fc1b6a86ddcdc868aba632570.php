...
<?php $component->withAttributes(['title' => 'Partner Workspace']); ?>
    <div class="min-h-screen bg-gray-50/30">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div class="bg-white rounded-[2rem] p-7 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-gray-100 hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-500 group">
                ...
                <h3 class="text-3xl font-black text-gray-900 tabular-nums tracking-tighter">RM<?php echo e(number_format($myTotalRevenue, 0)); ?></h3>
                <div class="mt-4 flex items-center gap-2">
                    <span class="text-[9px] font-black text-gray-400 uppercase tracking-widest"><?php echo e(number_format($myTotalSales)); ?> Transactions</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2rem] p-7 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-gray-100 hover:shadow-xl hover:shadow-blue-500/5 transition-all duration-500 group">
                ...
                <div class="flex items-end justify-between">
                    <h3 class="text-3xl font-black text-gray-900 tabular-nums tracking-tighter">RM<?php echo e(number_format($thisMonthRevenue, 0)); ?></h3>
                    <?php if($revenueChange !== null): ?>
                        <span class="flex items-center text-[10px] font-black <?php echo e($revenueChange >= 0 ? 'text-emerald-500 bg-emerald-50' : 'text-rose-500 bg-rose-50'); ?> px-2.5 py-1 rounded-xl uppercase tracking-wider shadow-sm">
            ...
            <div class="bg-white rounded-[2rem] p-7 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-gray-100 hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-500 group">
                ...
                <div class="flex items-end justify-between">
                    <h3 class="text-3xl font-black text-gray-900 tabular-nums tracking-tighter">RM<?php echo e(number_format($myCommission, 0)); ?></h3>
            ...
            <div class="bg-white rounded-[2rem] p-7 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-gray-100 hover:shadow-xl hover:shadow-amber-500/5 transition-all duration-500 group">
                ...
                <div class="flex items-end justify-between">
                    <h3 class="text-3xl font-black text-gray-900 tabular-nums tracking-tighter"><?php echo e(number_format($myTotalUnits)); ?></h3>
                    <span class="text-[9px] font-black <?php echo e($lowStockProducts->count() > 0 ? 'text-amber-500 bg-amber-50' : 'text-gray-400 bg-gray-50'); ?> px-2 py-1 rounded-lg uppercase tracking-wider">
                        <?php echo e($lowStockProducts->count() > 0 ? 'Action Needed' : 'Stable'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                ...
                <div class="space-y-6 relative z-10">
                    <?php $__currentLoopData = $insights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-start gap-4">
                            ...
                            <p class="text-sm font-bold leading-relaxed text-gray-100"><?php echo e($insight); ?></p>
                        </div>
            ...
            <div class="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-[0_8px_30px_rgb(0,0,0,0.02)] relative group" x-data="{ editing: false }">
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-around gap-8">
                        <div class="relative w-36 h-36 flex items-center justify-center">
                            <svg class="w-full h-full transform -rotate-90">
                                ...
                                <circle cx="72" cy="72" r="68" stroke="currentColor" stroke-width="8" fill="transparent" class="text-black" stroke-dasharray="<?php echo e(2 * pi() * 68); ?>" stroke-dashoffset="<?php echo e((1 - ($goalProgress / 100)) * (2 * pi() * 68)); ?>" style="transition: stroke-dashoffset 1s ease-in-out;"/>
                            </svg>
                            <div class="absolute flex flex-col items-center">
                                <span class="text-3xl font-black text-gray-900 tracking-tighter"><?php echo e($goalProgress); ?>%</span>
                        ...
                        <div class="text-center md:text-left">
                            ...
                            <h4 class="text-2xl font-black text-indigo-600 tracking-tighter">RM<?php echo e(number_format($monthlyGoal, 0)); ?></h4>
                            <p class="text-[10px] font-bold text-gray-400 mt-2 uppercase tracking-widest">RM<?php echo e(number_format($thisMonthRevenue, 2)); ?> Earned</p>
                        </div>
                    </div>
                <?php else: ?>
                ...
                <div x-show="editing" x-cloak class="absolute inset-0 bg-white/95 backdrop-blur-sm z-20 p-8 flex flex-col justify-center animate-in fade-in zoom-in duration-200 rounded-[2rem]">
                    <form action="<?php echo e(route('reseller.dashboard.goal')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        <div>
                            ...
                            <input type="number" name="monthly_goal" value="<?php echo e($monthlyGoal); ?>" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-4 text-center text-2xl font-black focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
                        </div>
            ...
            <div class="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-[0_8px_30px_rgb(0,0,0,0.02)] flex flex-col group hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-500">
                ...
                <div class="h-[200px] relative flex items-center justify-center">
                    ...
                    <div class="absolute flex flex-col items-center pointer-events-none">
                        <span class="text-2xl font-black text-gray-900">RM<?php echo e(number_format($thisMonthRevenue, 0)); ?></span>
                ...
                <div class="mt-8 grid grid-cols-2 gap-4">
                    <div class="flex flex-col items-center p-3 bg-gray-50 rounded-2xl">
                        ...
                        <span class="text-xs font-black text-emerald-600">RM<?php echo e(number_format($thisMonthRevenue * 0.15, 0)); ?></span>
                    </div>
                    <div class="flex flex-col items-center p-3 bg-gray-50 rounded-2xl">
                        <p class="text-[9px] font-black text-gray-400 uppercase mb-1">Orders</p>
                        <span class="text-xs font-black text-gray-900"><?php echo e($myRecentSales->count()); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)] overflow-hidden mb-10">
            <div class="px-8 py-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
                ...
                <a href="<?php echo e(route('reseller.orders.create')); ?>" class="text-[10px] font-black text-indigo-600 hover:underline uppercase tracking-widest">Purchase Stock</a>
            </div>
            <div class="p-8">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $lowStockProducts->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="flex flex-col">
                            <div class="flex justify-between items-start mb-4">
                                <div class="max-w-[70%]">
                                    <p class="text-[11px] font-black text-gray-900 uppercase truncate"><?php echo e($p->product?->name); ?></p>
                                    <p class="text-[9px] font-bold text-gray-400 uppercase tracking-widest mt-0.5"><?php echo e($p->product?->volume_ml); ?>ml Edition</p>
                                </div>
                                <div class="text-right">
                                    <span class="text-xs font-black <?php echo e($textColor); ?>"><?php echo e($p->quantity); ?></span>
                            ...
                            <div class="w-full h-1.5 bg-gray-50 rounded-full overflow-hidden">
                                <div class="h-full rounded-full <?php echo e($statusColor); ?> transition-all duration-1000 shadow-[0_0_8px_rgba(0,0,0,0.1)]" style="width: <?php echo e($percent); ?>%"></div>
                            </div>
                        </div>
        ...
        <div class="mb-6 flex items-end justify-between px-2">
            ...
            <a href="<?php echo e(route('reseller.sales.index')); ?>" class="text-[10px] font-black text-gray-400 hover:text-black uppercase tracking-widest transition-colors">View All</a>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <?php $__empty_1 = true; $__currentLoopData = $myRecentSales->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-indigo-50/20 transition-all group">
                                <td class="px-8 py-5">
                                    ...
                                    <p class="text-[10px] font-bold text-gray-400 uppercase mt-0.5"><?php echo e($sale->created_at->format('h:i A')); ?></p>
                                </td>
                                <td class="px-8 py-5">
                                    <p class="text-sm font-bold text-gray-900"><?php echo e($sale->product->name); ?></p>
                                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-0.5"><?php echo e($sale->product->volume_ml); ?>ml Edition</p>
                                </td>
                                ...
                                <td class="px-8 py-5 text-right">
                                    <p class="text-sm font-extrabold text-gray-900">RM<?php echo e(number_format($sale->total_price, 2)); ?></p>
                                </td>
                                <td class="px-8 py-5 text-right">
                                    <div class="flex justify-end">
                                        <div class="w-16 h-6">
                                            <canvas class="table-sparkline" data-values="<?php echo e(json_encode([rand(10,50), rand(30,70), rand(20,60), rand(50,90), rand(40,80), rand(70,100), rand(60,110)])); ?>"></canvas>
                                        </div>
                                    </div>
                                </td>
                            </tr>
    ...
    <script>
        ...
        // 1. KPI Sparklines
        createSparkline('sparklineTotalRev', <?php echo json_encode($sparkRevenue, 15, 512) ?>, '#6366f1');
        createSparkline('sparklineMonthly', <?php echo json_encode($sparkRevenue, 15, 512) ?>, '#3b82f6');
        createSparkline('sparklineEarnings', <?php echo json_encode($sparkRevenue->map(fn($v) => $v * 0.15), 15, 512) ?>, '#10b981');
        createSparkline('sparklineStock', <?php echo json_encode($sparkUnits, 15, 512) ?>, '#f59e0b');
        ...
        new Chart(donutCtx, {
            type: 'doughnut',
            data: {
                labels: <?php echo json_encode($topProductLabels->take(3), 15, 512) ?>,
                datasets: [{
                    data: <?php echo json_encode($topProductRev->take(3), 15, 512) ?>,
        ...
        new Chart(weeklyCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: <?php echo json_encode($weeklyVelocityData, 15, 512) ?>,
        ...
        new Chart(categoryCtx, {
            type: 'radar',
            data: {
                labels: <?php echo json_encode($categoryDistribution->keys(), 15, 512) ?>,
                datasets: [{
                    data: <?php echo json_encode($categoryDistribution->values(), 15, 512) ?>,
                    borderColor: '#8b5cf6',
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Documents\Project Code\rpims\resources\views/reseller/dashboard.blade.php ENDPATH**/ ?>