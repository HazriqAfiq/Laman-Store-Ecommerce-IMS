            ...
            <form action="{{ route('admin.resellers.update', $reseller) }}" method="POST" class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input id="commission_rate" name="commission_rate" type="number" step="0.01" value="{{ old('commission_rate', $reseller->commission_rate) }}"
                               class="w-full px-4 py-3 text-[14px] font-medium text-gray-900 bg-gray-50/50 border rounded-xl transition-all duration-300
                                      focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500
                                      {{ $errors->has('commission_rate') ? 'border-red-400 focus:ring-red-500/20 focus:border-red-500' : 'border-gray-200' }}">
